...
namespace ImGui
{
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, void* parent_hwnd = 0);  //##EDIT##//
    IMGUI_API void          End();
    ...
    IMGUI_API void                  TableSetBgColor(ImGuiTableBgTarget bg_target, ImU32 color, int column_n = -1);                
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_MultiSortable                   = 1 << 4,                      
    ImGuiTableFlags_NoSavedSettings                 = 1 << 5,               
    ImGuiTableFlags_ContextMenuInBody               = 1 << 6,                   
    ImGuiTableFlags_RowBg                           = 1 << 7,                     
    ImGuiTableFlags_BordersInnerH                   = 1 << 8,        
    ImGuiTableFlags_BordersOuterH                   = 1 << 9,           
    ImGuiTableFlags_BordersInnerV                   = 1 << 10,       
    ImGuiTableFlags_BordersOuterV                   = 1 << 11,           
    ImGuiTableFlags_BordersH                        = ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersOuterH,    
    ImGuiTableFlags_BordersV                        = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersOuterV,    
    ImGuiTableFlags_BordersInner                    = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersInnerH,    
    ImGuiTableFlags_BordersOuter                    = ImGuiTableFlags_BordersOuterV | ImGuiTableFlags_BordersOuterH,    
    ImGuiTableFlags_Borders                         = ImGuiTableFlags_BordersInner | ImGuiTableFlags_BordersOuter,      
    ImGuiTableFlags_NoBordersInBody                 = 1 << 12,              
    ImGuiTableFlags_NoBordersInBodyUntilResize      = 1 << 13,                  
    ImGuiTableFlags_ColumnsWidthStretch             = 1 << 14,                   
    ImGuiTableFlags_ColumnsWidthFixed               = 1 << 15,                          
    ImGuiTableFlags_SameWidths                      = 1 << 16,                               
    ImGuiTableFlags_NoHeadersWidth                  = 1 << 17,         
    ImGuiTableFlags_NoHostExtendY                   = 1 << 18,                            
    ImGuiTableFlags_NoKeepColumnsVisible            = 1 << 19,                 
    ImGuiTableFlags_PreciseWidths                   = 1 << 20,                                      
    ImGuiTableFlags_NoClip                          = 1 << 21,                          
    ImGuiTableFlags_PadOuterX                       = 1 << 22,          
    ImGuiTableFlags_NoPadOuterX                     = 1 << 23,          
    ImGuiTableFlags_NoPadInnerX                     = 1 << 24,                     
    ImGuiTableFlags_ScrollX                         = 1 << 25,                                 
    ImGuiTableFlags_ScrollY                         = 1 << 26                
};
...
enum ImGuiTableBgTarget_
{
    ...
    ImGuiTableBgTarget_RowBg0                       = 3,                       
    ImGuiTableBgTarget_RowBg1                       = 4,                  
    ImGuiTableBgTarget_CellBg                       = 5               
};
...
struct ImDrawData
{
    ...
    ~ImDrawData()   { Clear(); }
    void Clear()    { Valid = false; CmdLists = NULL; CmdListsCount = TotalVtxCount = TotalIdxCount = 0; DisplayPos = DisplaySize = FramebufferScale = ImVec2(0.f, 0.f); OwnerViewport = NULL; }       
...
struct ImGuiViewport
{
    ...
    ImVec2              GetWorkSize()           { return ImVec2(Size.x - WorkOffsetMin.x + WorkOffsetMax.x, Size.y - WorkOffsetMin.y + WorkOffsetMax.y); }    
};
